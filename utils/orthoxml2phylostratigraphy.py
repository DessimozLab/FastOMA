...
# you need to install pyham https://github.com/DessimozLab/pyham 
...
treeprofile = ham_analysis.create_tree_profile(outfile= working_folder+"/out_folder/phylostratigraphy.html")
