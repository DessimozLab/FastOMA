...
def read_infer_xml_rhogs_batch(rhogid_batch_list):
    ...
    for rhogid_num in rhogid_batch_list:
        hogs_rhogs_xml = read_infer_xml_rhog(rhogid_num)  # orthoxml_to_newick.py list of hog object
...
def infer_hogs_for_rhog_levels_recursively_future(sub_species_tree, species_names_rhog, rhogid_num):
    ...
    if sub_species_tree.is_leaf():
        ...
        singletone_hog_out = singletone_hog_(sub_species_tree, species_names_rhog, rhogid_num)
...
def singletone_hog_(node_species_tree, species_names_rhog, rhogid_num):
